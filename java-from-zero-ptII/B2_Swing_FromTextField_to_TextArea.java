/*
 * For the next exercise we'll be combining JtextField, JtextArea and JButton.
 * 
 * Exercise => Make a program where you introduce text in a text field and when you press 
   a button, that text goes to other text area. */
...
public class B2_Swing_FromTextField_to_TextArea extends JFrame implements ActionListener{
    /*As we saw in a previous lesson, when we are going to work with buttons, we've to 
    ...
    String text = ""; 
    /*This string variable is for later use it to program the action of getting the data 
    from textfield and setting the data in textarea*/
    ...
    public B2_Swing_FromTextField_to_TextArea(){
        ...
        //we say to the program thet the event will come from button0

        textarea0 = new JTextArea();
        scrollpanel0 = new JScrollPane(textarea0); 
        // we add a scrollpanel inside textarea.
