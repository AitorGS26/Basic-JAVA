...
public class E2_RGB_button extends JFrame implements ActionListener {
...
//Declaring 3 labels for the users knowledge of each button which colour is
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == button){
            /*we get the information of each combobox ad pass it to String for beaing 
...
//we put the background to the check button for checking the colour we've created
    ...
    public static void main(String [] args){
        E2_RGB_button RGBbutton = new E2_RGB_button();
